...
class PositionalEncoding(tf.keras.layers.Layer):
    def __init__(self, hparams):
        ...
        self.pos_encoding = self.positional_encoding(
            hparams.vocab_size, hparams.d_model
        )
...
def decoder_layer(hparams, name="decoder_layer"):
    ...
    attention1 = MultiHeadAttention(hparams, name="attention_1")(
        inputs={
            "query": inputs,
            "key": inputs,
            "value": inputs,
    ...
    attention2 = MultiHeadAttention(hparams, name="attention_2")(
        inputs={
            "query": attention1,
            "key": enc_outputs,
            "value": enc_outputs,
...
def transformer(hparams, name="transformer"):
    ...
    outputs = tf.keras.layers.Dense(units=hparams.vocab_size, name="outputs")(
        dec_outputs
    )
